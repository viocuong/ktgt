    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if tool == 'wavsteg':
                ...
                os.system(f"/home/cuongnv/project/ktgt/ktgt_env/bin/stegolsb wavsteg -h -i /home/cuongnv/project/ktgt/media/media/{fileName}.wav  -s /home/cuongnv/project/ktgt/media/media/message.txt -o /home/cuongnv/project/ktgt/media/media/{fileName}_wavsteg.wav -n 1")
